...
export default function AgendaPage() {
  ...
  const syncGoogleCalendar = async (a: Appointment) => {
    ...
    if (!response.ok) {
      if (result.error === 'not_connected') {
        alert('Todavía no conectaste tu Google Calendar. Cerrá sesión y volvé a entrar con Google para habilitarlo.')
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-xs text-teal-700 bg-teal-50 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg mb-6">
